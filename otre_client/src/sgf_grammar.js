  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_Start() {
        ...
        if (result2 !== null) {
          var result3 = parse_Tokens();
          if (result3 !== null) {
            var result4 = parse_Variations();
            if (result4 !== null) {
      ...
      function parse_Variations() {
        ...
        var result3 = result4 !== null
          ? (function(var1, var2, more) { return [var1, var2].concat(more); })(result4[1], result4[5], result4[8])
          : null;
        if (result3 !== null) {
          var result0 = result3;
        } else {
      ...
      function parse_MoreVars() {
        ...
        var result3 = result4 !== null
          ? (function(move, more) { return [move].concat(more); })(result4[1], result4[4])
          : null;
        if (result3 !== null) {
          var result0 = result3;
        } else {
      ...
      function parse_Moves() {
        ...
        if (result5 !== null) {
          var result6 = parse_Tokens();
          if (result6 !== null) {
            var result7 = parse_Variations();
            if (result7 !== null) {
      ...
      function parse_MoreData() {
        ...
        var result3 = result4 !== null
          ? (function(data, more) { return [data].concat(more); })(result4[1], result4[4])
          : null;
        if (result3 !== null) {
          var result0 = result3;
        } else {
